        ...
        <div className="hidden md:flex justify-between items-center gap-5">
          <div>
            <button onClick={toggleTheme}>
              {isDarkMode ? (
                <Sun className="cursor-pointer text-orange-500" size={24} />
              ) : (
                <Moon className="cursor-pointer text-yellow-400" size={24} />
              )}
            </button>
          </div>

          <div className="relative">
            <Bell className="cursor-pointer text0gray-500" size={24} />
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <Image src="https://inventorymanagement-3s.s3.amazonaws.com/profile.png" alt="profile" width={50} height={50} className="rounded-full object-cover h-full" />
